...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>events</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EventsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.events"));
				Town root = EventsFactory.eINSTANCE.createTown();
