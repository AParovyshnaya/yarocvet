...
public class EventsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EventsPackage.TOWN: {
				Town town = (Town)theEObject;
				T result = caseTown(town);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventsPackage.TOWN_TYPE: {
				TownType townType = (TownType)theEObject;
				T result = caseTownType(townType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventsPackage.REGION: {
				Region region = (Region)theEObject;
				T result = caseRegion(region);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventsPackage.ROAD: {
				Road road = (Road)theEObject;
				T result = caseRoad(road);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventsPackage.EVENTS_MAP: {
				EventsMap eventsMap = (EventsMap)theEObject;
				T result = caseEventsMap(eventsMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EventsPackage.SPEAKER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Town Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Town Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTownType(TownType object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseEventsMap(EventsMap object) {
		return null;
	}
